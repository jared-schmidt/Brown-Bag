        ...
        return <div className="panel panel-default">
                <div className="panel-body container-fluid">
                    <div className='row'>
                        ...
                        <div className="col-xs-4 col-md-4">{this.data.userRead ? "You read this" : null}</div>
                        <div className="col-xs-4 col-md-4">{this.data.isAdmin ? this.renderDeleteBtn(messageid) : null}</div>
                    </div>
                </div>
        </div>
    }
