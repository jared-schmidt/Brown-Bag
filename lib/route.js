...
Router.map(function(){
    ...
    this.route('places', {
        ...
        onStop: function(){
            console.log("stop");
            // console.log($('#page-content-wrapper')[0]);
            // console.log($('#page-content-wrapper > div')[0]);
            // React.unmountComponentAtNode($('#page-content-wrapper > div')[0]);
            // $('#page-content-wrapper > div').remove();
        }
    });
    this.route('orders',{
        path:'/orders',
